package com.m7.abs.support.core.aspect;
...
public class LogPrintAspect {
    ...
    public void doBefore(JoinPoint joinPoint) throws Throwable {
        ...
        if (annotation != null) {
            ...
            if (StringUtils.isNotEmpty(logDesc)) {
                ...
                log.info("URL            : " + request.getMethod() + " [{}] [{}] => {}" ,HttpUtil.getIpAddr(request), annotation.logDesc(),request.getRequestURL().toString());
                // 打印请求入参
                log.info("Request Args   : " + FastJsonUtils.toJSONString(reqObject));
            }
        }
    }
    ...
    public Object doAround(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        if (annotation != null) {
            ...
            if (StringUtils.isNotEmpty(logDesc)) {
                ...
                log.info("Time-Consuming : " + l + " ms" + " ,Response Args  : " + JSONObject.toJSONString(result));
            }
        }
        return result;
    }
     ...
     * @throws Exception
     */
    public WebAspect getWebAspectAnnotation(JoinPoint joinPoint) throws Exception {
