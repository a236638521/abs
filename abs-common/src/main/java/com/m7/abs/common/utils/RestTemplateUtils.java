...
public class RestTemplateUtils {
    ...
    public static <T> ResponseEntity<T> postJson(String url, HttpHeaders headers, Object requestBody, Class<T> responseType, Object... uriVariables) {
        if (headers == null) {
    ...
    public static <T> ResponseEntity<T> postJson(String url, HttpHeaders headers, Object requestBody, ParameterizedTypeReference<T> responseType, Object... uriVariables) {
        if (headers == null) {
            headers = new HttpHeaders();
        }
        headers.add(HttpHeaders.CONTENT_TYPE, MediaType.APPLICATION_JSON_VALUE);
        ...
        log.info("Request entity: " + FastJsonUtils.toJSONString(requestEntity));
        ResponseEntity<T> exchange = restTemplate.exchange(url, HttpMethod.POST, requestEntity, responseType, uriVariables);
        log.info("Response entity: [" + exchange.getStatusCode() + "]" + FastJsonUtils.toJSONString(exchange.getBody()));
        return exchange;
    }
