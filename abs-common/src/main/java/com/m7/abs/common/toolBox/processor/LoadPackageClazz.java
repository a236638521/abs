...
public class LoadPackageClazz {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        String[] packages = {"com.m7.abs.common.toolBox.tools"};
        Set<Class<?>> classSet = new LoadPackageClazz(packages, ToolBoxType.class).getClassSet();
        System.out.printf(FastJsonUtils.toJSONString(classSet));
    }
     ...
     */
    public LoadPackageClazz(String[] packagesToScan, Class<? extends Annotation>... annotationFilter) {
